...
public class SmallestRunner {
	public static void main(String args[]) {
		...
		System.out.println(RaySmallest.go(new int[] { 10, 10, 10, 11, 456 }));
		System.out.println(RaySmallest.go(new int[] { -111, 1, 2, 3, 9, 11, 20, 30 }));
		System.out.println(RaySmallest.go(new int[] { 9, 8, 7, 6, 5, 4, 3, 2, 0, -2, -989 }));
		System.out.println(RaySmallest.go(new int[] { 12, 15, 18, 21, 23, 1000 }));
		System.out.println(RaySmallest.go(new int[] { 250, 19, 17, 15, 13, 11, 10, 9, 6, 3, 2, 1, -455 }));
		System.out.println(RaySmallest.go(new int[] { 9, 10, -8, 10000, -5000, 1000 }));
	}
}